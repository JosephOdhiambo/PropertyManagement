...
INSERT INTO `properties` (`property_id`, `property_no`, `type`, `price`, `details`, `image`, `Apartment/House`) VALUES
(28, 512, 'Studio Apartment', 15000, 'A single-room apartment with a living space, kitchenette, and bathroom.', 'delux_img1.jpg', 'Apartment'),
(30, 504, 'One-Bedroom Apartment', 16000, 'An apartment with one separate bedroom, a living room, a kitchen, and a bathroom.', 'Luxury_img10.jpg', 'Apartment'),
(31, 302, 'Two-Bedroom Apartment', 14000, 'An apartment with two separate bedrooms, a living room, a kitchen, and a bathroom.', 'Standard _img16.jpg', 'Apartment'),
(32, 312, 'Duplex Apartment', 13000, 'An apartment with two levels, typically with a living space, kitchen, and bathroom on one level, and bedrooms on the other level.', 'Suit_img22.jpg', 'Apartment'),
(33, 205, 'Loft Apartment', 120000, 'An apartment with an open floor plan, high ceilings, and large windows.', 'Twin_img24.jpg', 'Apartment'),
(34, 0, 'Penthouse Apartment', 180000, 'An apartment located on the top floor of a building, often with luxurious amenities such as a private elevator, rooftop terrace, and panoramic views.', 'parking.jpg', 'Apartment'),
(35, 203, 'Bungalow', 182729, 'A bungalow is a small, one-story house that is typically rectangular in shape. It often has a low-pitched roof with wide, overhanging eaves, and may have a front porch or veranda. Bungalows are popular for their simple, functional design and often feature an open floor plan.', 'pexels-eneida-nieves-803975.jpg', 'House'),
(36, 92238, 'Ranch', 490000092, 'A ranch house is a single-story home that is typically long and low to the ground. It often has a simple, rectangular or L-shaped design with a low-pitched roof and wide overhanging eaves. Ranch houses typically have an open floor plan and feature large windows and sliding glass doors that open to the backyard.', 'pexels-olivia-nuño-1001470.jpg', 'House'),
(37, 857, 'Colonial', 4000000, 'A colonial-style house is typically a two-story home with a symmetrical façade and a rectangular or square shape. It often has a steeply pitched roof, a central entryway, and evenly spaced windows. Colonial houses often have a formal living room, dining room, and kitchen on the first floor, with bedrooms located on the second floor.', 'pexels-caio-1038259.jpg', 'House');
